...
class Game:
    def __init__(self):
        ...
        # collection of Position(s) organized by Position val
        self.positions = {}
        ...
        while len(turns) > 0:
            ...
            for position in self.positions[turn]:
                ...
                if card_won:
                    ...
                    print(
                        f'Card {card.id} won with {card.value_at_win} points')
...
class Bingo_Card:
    def __init__(self, matrix, id):
        self.id = id
        # a 2d array 5x5 of Position(s) representing the Bingo card
        self.matrix = matrix
        self.won = False
        self.turn_won = None
        self.value_at_win = 0
